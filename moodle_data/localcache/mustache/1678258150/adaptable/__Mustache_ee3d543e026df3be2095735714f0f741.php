...
class __Mustache_ee3d543e026df3be2095735714f0f741 extends Mustache_Template
{
...
';
        $value = $context->find('menuslinkright');
        $buffer .= $this->sectionB31c77bb5b6f2e2d3496e98edc56dacb($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionB31c77bb5b6f2e2d3496e98edc56dacb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                        <li class="my-auto m-1">{{{cartscount}}} {{{topmenus}}}</li>
                        ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('cartscount'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= ' ';
                $value = $this->resolveValue($context->find('topmenus'), $context);
                $buffer .= ($value === null ? '' : $value);
