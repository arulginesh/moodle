define(['jquery', 'core/ajax'
    ...
    return {
        stripe_payment: function(publishablekey, secret_key, courseid, amount, currency, description, pageurl, couponid, user_id, instance_id, please_wait_string, buy_now_string, get_cost_from_plugin, cost, email, invalid_code_string) {
            // coupon js code
            ...
            buyBtn.addEventListener("click", function (evt) {
                var adjustedAmount = $("#totaldueamount_hidden").val();	
                if(typeof adjustedAmount != "undefined"){	
                ...
                var promises = ajax.call([{
                    ...
                    args: { secret_key: secret_key, courseid: courseid, amount: amount, currency: currency, description: description, couponid: couponid, user_id: user_id, instance_id: instance_id, pageurl: pageurl},
                }]);
                promises[0].then(function(data) {
                    if(data.status) {
