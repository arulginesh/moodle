...
if($page!="/store/coursescheckout.php"){ ?>
    <!--- Orginal code Start-->
    <div align="center">
...
<!--- Orginal code end-->
<?php } else{ ?>
    <!--- Duplicated the orginal code and customized for store multi payment Start-->
    <div align="center">
    <div class="stripe-img">
        <img src="<?php echo $CFG->wwwroot; ?>/enrol/stripepayment/pix/stripe.png"></div>
        <p><?php print_string("paymentrequired") ?></p>
        <p ><b><span id="totaldueamount"><?php echo get_string("cost").": {$currency_symbol}{$totalcost}"; ?></span></b></p>
        <?php if ($enable_coupon_section) { ?>
            <div class="couponcode-wrap">
                <span class="couponcode-text"> <?php echo get_string("couponcode", "enrol_stripepayment"); ?>: </span>
                <input type=text id="coupon"/>
...
<!--- Duplicated the orginal code and customized for store multi payment End-->
<?php }?>
<style>
    .card{
        width:75% !important;
