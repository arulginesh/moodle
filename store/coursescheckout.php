...
<td id="rmstyle"><a onclick="removecartcrs(<?php echo $course->id ;?>)"><i style="font-size:20px" class="fa fa-times-circle" aria-hidden="true"></i></a></td>
<td id="rmimagestyle"><a  target="_blank" href="<?php echo "https://svhs.co/store/online-high-school-$bname-courses/$coursenl-id-$course->id/" ; ?>">
...
#adaptable-page-header-wrapper {
	...
	<div style="margin-top: 2%;"  class="card nn">
	<?php 
